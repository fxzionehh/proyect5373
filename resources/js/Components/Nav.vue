...
<template>
  <div>
    <nav class="sticky top-0 z-50 bg-zinc-950 shadow-2xl">
      ...
      <div class="flex items-center justify-between px-4 sm:px-6 lg:px-10 py-3">
        ...
        <div class="flex items-center gap-4">
          ...
          <div v-if="user" class="relative hidden sm:block">
            ...
            <div
              v-if="dropdownOpen"
              class="absolute right-0 top-full mt-2 w-56 bg-zinc-900 border border-zinc-800 rounded-xl shadow-2xl py-2 overflow-hidden"
            >

              <template v-if="can('ver preparacion')">
                <Link
              ...
              <template v-if="can('ver producto')">
                <div class="border-t border-zinc-800 my-1"></div>
      ...
      >
        <div v-if="user" class="pt-3 space-y-2">

          <div class="flex items-center gap-2 mb-2 px-2">
            <i class="fa-solid fa-user text-xs text-zinc-400"></i>
            <span class="text-xs text-zinc-200">{{ user.name }}</span>
          </div>

          <Link
            v-if="can('ver preparacion')"
            href="/dashboard/preparacion"
